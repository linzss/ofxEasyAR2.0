...
void easyar_Frame_typeName(const easyar_Frame * This, /* OUT */ easyar_String * * Return);
...
void easyar_ListOfPointerOfImage__ctor(easyar_Image * * begin, easyar_Image * * end, /* OUT */ easyar_ListOfPointerOfImage * * Return);
...
void easyar_ListOfPointerOfTargetInstance__ctor(easyar_TargetInstance * * begin, easyar_TargetInstance * * end, /* OUT */ easyar_ListOfPointerOfTargetInstance * * Return);
