...
void easyar_ImageTarget_typeName(const easyar_ImageTarget * This, /* OUT */ easyar_String * * Return);
...
void easyar_ListOfPointerOfImageTarget__ctor(easyar_ImageTarget * * begin, easyar_ImageTarget * * end, /* OUT */ easyar_ListOfPointerOfImageTarget * * Return);
